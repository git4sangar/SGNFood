...
while true; do
  ...
  rsync -azP -e "ssh -i /home/tstone10/sgn/bkup/private/projs/SGNFood/rsync-key -o StrictHostKeyChecking=no" ../SGNFood svaithiy@172.16.176.129:/home/svaithiy/sgn/projs
done
